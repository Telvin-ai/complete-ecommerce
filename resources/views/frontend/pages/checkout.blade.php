	...
	<script>
		$(document).ready(function(){
			$('.shipping select[name=shipping]').change(function(){
				let cost = parseFloat( ksh(this).find('option:selected').data('price') ) || 0;
				let subtotal = parseFloat( ksh('.order_subtotal').data('price') ); 
				let coupon = parseFloat( ksh('.coupon_price').data('price') ) || 0; 
				// alert(coupon);
